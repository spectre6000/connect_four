...
#Takes the place of the standard I/O to enable testing
  ...
  def get_player_name(mark)
    @out.send :puts, "Player #{mark} name:"
    gets.chomp
  end

  def get_high_score
    @out.send :puts, "Best out of how many?"
    gets.chomp.to_i
  end
